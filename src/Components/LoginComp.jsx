...
const LoginComp = () => {
  const { apiUrl, setUserName, userToken, setUserToken } = StoreFunction();
  ...
  function loginUser(e) {
    e.preventDefault();
    const userId = e.target.children[0].value;
    ...
    <>
      <div className="login-outer-container">
        <div className="login-container">
          <div className="login-logo-container" title="Threads Clone">
            <svg
              aria-label="Threads"
              class="x1ypdohk"
              fill="white"
          ...
          <div>Log in with your Threads account</div>
